...
import './Home.css';
import logo1 from './car-banner-new-1.jpg';
import logo2 from './Fimage.png'


import logo111 from "./modern-automobile-mechanic-composition.jpg";
import logo222 from "./Repair & Maintenance.jpg";
                ...
                <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" >
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src={logo1} className="d-block w-100" alt="car-detailing" />
                            <div className="carousel-caption text-left">
                                ...
                                <a href="/login" className="btn-menu btn btn-outline-danger">Book Appointment</a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container">
                ...
                <div className="row section" id="about-me">
                    <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        <div className="view">
                            <img src={logo2} alt="Classical Motors" id="image" className="img-fluid" />
                        </div>
                    </div>
            ...
            <div className="container-home-service">
                ...
                <div class="row mbr-justify-content-center">
                    ...
                    <div class="col-lg-4 mbr-col-md-10">
                        <div class="wrap">
                            <div class="w-100 mb-5 p-2">
                                <div class="pull-left"><img src={logo111} class="iconimg" /></div>
                    ...
                    <div class="col-lg-4 mbr-col-md-10">
                        <div class="wrap">
                            <div class="w-100 mb-5 p-2">
                                <div class="pull-left"><img src={logo222} class="iconimg" /></div>
